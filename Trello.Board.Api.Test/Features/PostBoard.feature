Feature: Post trello board

    @positive_cases
    Scenario Outline: Post board request successfully
        ...
        Examples:
          ...
          | Privaßte Board Test | Private board created test | null           | null          | none           | all      | true          | true         | private               | disabled     | members        | members           | true           | true             | green            | regular         |